...
func (app *Config) HandleSubmission(w http.ResponseWriter, r *http.Request) {
	...
	case "log":
		app.logItemViaRCP(w, requestPayload.Log)
	case "mail":
		app.sendMail(w, requestPayload.Mail)
	default:
		app.errorJSON(w, errors.New("unkwon action"))
	}
}
...
func (app *Config) authenticate(w http.ResponseWriter, a AuthPayload) {
	...
	// we'll read response.body that comes from the auth service
...
func (app *Config) logItemViaRCP(w http.ResponseWriter, l LogPayload) {
	...
	rcpPayload := RCPPayload{
		Name: l.Name,
		Data: l.Data,
	}

	var result string
	err = client.Call("RCPServer.LogInfo", rcpPayload, &result)
	if err != nil {
		app.errorJSON(w, err)
		return
	}
